								...
								<header id="header">
									...
									<!-- Logo -->
										<div id="logo">
											...
											<h1><img src="images/checkbox.png" /> <a href="#" id="logo">listCROSS</a></h1>
									...
									<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><a href="left-sidebar.html">My Lists</a></li>
                                                <li><a href="left-sidebar.html">About listCross</a></li>
												<li><a href="right-sidebar.html">Log Out</a></li>
									...
									<div>
										<div class="row">
											<div class="7u">
												...
												<p>Finally an answer to the question...</p><p>"What do you want to do tonight?"</p>
                                                
											</div>
											<div class="5u">
												<ul>
													<li><a href="#" class="button button-big button-icon button-icon-paper">New List</a></li>
													<li><a href="#" class="button button-alt button-big button-icon button-icon-arrow">Cross It</a></li>
												</ul>
											</div>
										</div>
									</div>
				...
				<div class="container">
					<div class="row">
						<div class="4u">
							...
							<!-- Box -->
								<section class="box box-feature">
									<a href="#" class="image image-centered"><img src="images/user-icon-blue.png" alt="" /></a>
									<div class="inner">
										<header>
											<h2>My Profile</h2>
						...
						<div class="4u">
							...
							<!-- Box -->
								<section class="box box-feature">
									<a href="#" class="image image-centered"><img src="images/checkbox.png" alt="" /></a>
									<div class="inner">
										<header>
											<h2>My Lists</h2>
						...
						<div class="4u">
							...
							<!-- Box -->
								<section class="box box-feature last">
									<a href="#" class="image image-centered"><img src="images/user-icon-blue-group.png" alt="" /></a>
									<div class="inner">
										<header>
											<h2>Cohorts</h2>
							...
							<!-- Sidebar -->
								<div id="sidebar">
									<section class="widget-thumbnails">
										...
										<a href="http://html5up.net/" class="button button-icon button-icon-paper">More</a>
									</section>
								</div>
							...
							<!-- Content -->
								<div id="content">
									<section class="last">
										...
										<a href="http://html5up.net/" class="button button-icon button-icon-rarrow">More @ HTML5 UP</a>
									</section>
								</div>
