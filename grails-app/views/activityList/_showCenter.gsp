<div id="show-activityList" class="content scaffold-show" role="main">
			<h1>${activityListInstance?.title}</h1>
			<div id="subheadingText">${activityListInstance?.description}</div>
		...
		<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${activityListInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
