...
<html>
	...
	<body>
		<a href="#create-activityList" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-activityList" class="content scaffold-create" role="main">
